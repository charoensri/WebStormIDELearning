  ...
  return (
    <Layout title="Alerts & Referrals">
      ...
      <div className="recent-visits-section" style={{ borderLeft: '4px solid #ef4444' }}>
        ...
        <p style={{ marginBottom: '1rem' }}>Patients who have exhausted all available treatments or have unverified ailments.</p>
      ...
      <div className="recent-visits-section" style={{ borderLeft: '4px solid #f59e0b', marginTop: '3rem' }}>
        ...
        <p style={{ marginBottom: '1rem' }}>Patients with 3+ recurrences of the same ailment within 30 days.</p>
        <table className="visit-table">
          <thead>
            <tr>
              <th>Patient</th>
